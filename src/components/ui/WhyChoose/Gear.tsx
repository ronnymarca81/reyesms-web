...
export const Gear: React.FC<GearProps> = ({
  ...
  const renderLine = () => {
    ...
    const lineClasses: Record<string, string> = {
      ...
      bottom:
        "absolute -bottom-16 left-1/2 transform -translate-x-1/2 w-0.5 h-16 bg-gray-300",
      left: "absolute -left-16 top-1/2 transform -translate-y-1/2 h-0.5 w-16 bg-gray-300",
      right:
        "absolute -right-16 top-1/2 transform -translate-y-1/2 h-0.5 w-16 bg-gray-300"
    };
