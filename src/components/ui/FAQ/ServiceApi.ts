...
export const faqData: FAQItem[] = [
  {
    id: '1',
    question: 'What kinds of commercial spaces do you service?',
    answer:
      'We provide comprehensive cleaning services for a wide variety of commercial spaces including offices, retail stores, plaza, event venues, warehouses, restaurants, and industrial facilities. Our team is trained to handle the unique cleaning requirements of each type of business environment.',
  },
  {
    id: '2',
    question: 'How is your commercial cleaning priced?',
    answer:
  ...
  {
    id: '3',
    question: 'Do I need to commit to a long-term cleaning contract?',
    answer:
  ...
  {
    id: '4',
    question: 'Is it necessary for someone to be on-site during cleaning?',
    answer:
      'Not at all. We work around your schedule and follow strict security protocols for unsupervised access',
  },
  {
    id: '5',
  ...
  {
    id: '6',
    question: 'How is Reyes Maintenence  different from other commercial cleaning services?',
    answer:
