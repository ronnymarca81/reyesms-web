      ...
      <div className="grid lg:grid-cols-2 min-h-[600px]">
        ...
        <div className="flex items-center justify-center p-8 lg:p-12 z-10 relative">
          <div className="max-w-xl w-full">
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight mb-10">
            ...
            <div className="space-y-6 mb-10">
              {safetyFeatures.map((feature, index) => (
                <div key={index} className="flex items-center space-x-4">
                  <div className="bg-red rounded-lg p-2 flex-shrink-0 shadow-md">
                    <Check className="w-5 h-5 text-red-800 font-bold" />
                  </div>
            ...
            <div className="space-y-4 lg:space-y-0 lg:flex lg:space-x-6">
              <button
                ...
                className="w-full lg:w-auto bg-red-700 hover:bg-red-800 text-white px-10 py-4 rounded-lg font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 border-2 border-red-700 hover:border-red-800"
              >
                ENQUIRY NOW
              </button>
              ...
              <button
                ...
                className="w-full lg:w-auto bg-red-700 hover:bg-red-800 text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center space-x-3 border-2 border-white hover:border-red-200"
              >
                <Phone className="w-6 h-6" />
                <span>CALL NOW: { defaultContactInfo.phone }</span>
              </button>
            </div>
          </div>
        </div>
